...
More on this in an upcoming blog post. For now, to play with kojo-ai, you can use the [latest release and provided instructions](https://github.com/litan/kojo-ai-3/releases/tag/v0.6.1).
